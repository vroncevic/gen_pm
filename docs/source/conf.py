...
Copyright
    ...
    gen_pm is distributed in the hope that it will be useful, but
...
version: str = '2.0'
release: str = 'https://github.com/vroncevic/gen_pm/releases'
